@if($data)
    ...
    @can ($action->getPolicy(), $data)
        ...
        @if($key == 3)
        <a href="#" onclick="get_link({{$data->id}});return false;" class="btn btn-sm btn-warning pull-right view" style="margin-left: 5px;" title="Ver link" >
            <i class="voyager-documentation"></i> <span class="hidden-xs hidden-sm">Link</span>
        </a>
        @endif
